...
workspace_data_file = 'data_2017_11_10.mat';
if 0
    ...
    save(workspace_data_file, 'scz', 'bip',          'alex_shape_param', 'chrnumvec', 'posvec', 'mask_in_9m', 'index_to_9m', 'mafvec_9m', 'Hvec_9m', 'tldvec_9m', 'numSNPsInLDr2_gt_r2min_vec', 'nprune');
    keyboard
    clear
    return
else
