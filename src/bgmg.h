...
extern "C" {
  ...
  DLL_PUBLIC int64_t bgmg_set_weights(int context_id, int length, double* values);
  DLL_PUBLIC int64_t bgmg_set_ref_ld(int context_id, int length, int r2bins, double* sum_r2, double* sum_r4);
